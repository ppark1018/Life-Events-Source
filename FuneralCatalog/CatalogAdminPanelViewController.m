//
//  CatalogAdminPanelViewController.m
//  FuneralCatalog
//
...
#import "CatalogAdminPanelViewController.h"

@implementation CatalogAdminPanelViewController
...
- (IBAction)authenticate
{
    ...
    {
        [self performSegueWithIdentifier:@"ToAdminPanelSegue" sender:self.okayButton];
    }
}
